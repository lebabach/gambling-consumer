...
@RestController
@RequestMapping("/api/gamblingconsumer-kafka")
public class GamblingconsumerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GamblingconsumerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GamblingconsumerKafkaResource(KafkaProperties kafkaProperties) {
