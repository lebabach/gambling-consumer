package microservices.gambling.consumer.config.timezone;

import microservices.gambling.consumer.GamblingconsumerApp;
import microservices.gambling.consumer.config.SecurityBeanOverrideConfiguration;
import microservices.gambling.consumer.repository.timezone.DateTimeWrapper;
import microservices.gambling.consumer.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, GamblingconsumerApp.class})
