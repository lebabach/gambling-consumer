package microservices.gambling.consumer.web.rest;

import microservices.gambling.consumer.config.KafkaProperties;
...
class GamblingconsumerKafkaResourceIT {
    ...
    void setup() {
        ...
        GamblingconsumerKafkaResource kafkaResource = new GamblingconsumerKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/gamblingconsumer-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/gamblingconsumer-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
